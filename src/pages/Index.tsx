          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 animate-fade-in">
              <h1 className="text-5xl font-bold text-gray-900 leading-tight">
                ...
                <span className="text-secondary"> 0% до 6 месяцев!</span>
              </h1>
              <p className="text-xl text-gray-600">
                Создайте идеальное место для хранения без переплат! Молодожёнам — премиум рассрочка 12 месяцев!
              </p>
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                <p className="text-red-700 font-semibold mb-2">🎉 Акция действует до конца 2025 года!</p>
                <p className="text-red-600 text-sm">Успейте оформить рассрочку 0% на выгодных условиях</p>
              </div>
            </div>
            ...
            <div className="relative animate-scale-in">
              ...
              <div className="absolute -bottom-4 -right-4 bg-primary text-white p-4 rounded-lg shadow-lg">
                ...
                <p className="text-sm">до 6 месяцев</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Создайте гардеробную онлайн и получите расчёт стоимости"
              },
              {
                icon: "Shield",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              {
                image: "/img/0e63278a-68e8-4ee8-8beb-85d3498b757d.jpg",
                title: "Шкаф с зеркалами и пескоструем",
                description: "Элегантные матовые панели и зеркальные поверхности"
              }
            ].map((project, index) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              {
                step: "2", 
                title: "Онлайн проектирование",
                description: "Создайте проект в нашем конструкторе или приедем для замера"
              },
              {
                step: "3",
                title: "Подписание договора", 
                description: "Оформление рассрочки 0% до 6 месяцев (молодожёнам до 12 месяцев)"
              },
              {
                step: "4",
                title: "Изготовление и установка",
                description: "Готовая гардеробная от 7 дней с гарантией 1 год"
              }
            ].map((step, index) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                location: "Ялта",
                rating: 5, 
                text: "Отличное качество материалов и фурнитуры. Гардеробная служит уже год — всё как новое!"
              }
            ].map((review, index) => (
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">
              Оставьте заявку сейчас и получите доступ к онлайн конструктору + рассрочку 0%!
            </h2>
